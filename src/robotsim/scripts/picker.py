    ...
    def move_down_rows(self):
        ...
        if self.position.x < 0:
            ...
            while not(self.has_bin):
                 pass
            rospy.loginfo("Bin attached moving now")

            self.move_x_steps(20)
...
if __name__ == '__main__':
    ...
    p = picker(rospy.get_name(), True, row_width, object_width,  "/robot_" + bin_name)  # Create an instance of above class
