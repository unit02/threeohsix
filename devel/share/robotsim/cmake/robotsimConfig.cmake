...
if("TRUE" STREQUAL "TRUE")
  set(robotsim_SOURCE_PREFIX /home/lavitasy/306project/threeohsix/src/robotsim)
  set(robotsim_DEVEL_PREFIX /home/lavitasy/306project/threeohsix/devel)
  set(robotsim_INSTALL_PREFIX "")
  set(robotsim_PREFIX ${robotsim_DEVEL_PREFIX})
else()
  set(robotsim_SOURCE_PREFIX "")
  set(robotsim_DEVEL_PREFIX "")
  set(robotsim_INSTALL_PREFIX /home/lavitasy/306project/threeohsix/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robotsim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lavitasy/306project/threeohsix/src/robotsim/${idir}'.  Ask the maintainer 'eliza <eliza@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lavitasy/306project/threeohsix/devel/lib;/opt/ros/indigo/lib)
